...
VLMExtractor retired in favor of NeuralFallback.reconcile() via BAML. Coverage
lives in src/backend/tests/test_agent_nodes.py (stubbed) and
scripts/smoke_agentic_vlm.py (live Gemini).
"""
import pytest
