...
Legacy EntityExtractor retired — its role is now split between heuristics.py
(spatial/regex field extraction used by LocalExtractor) and the BAML
ExtractInvoice / ReconcileInvoice functions.
"""
import pytest
