...
#
# EasyOCR / GOT-OCR 2.0 / Docling OCR engine. Superseded by
# src/backend/extraction/local_extractor.py (PaddleOCR-v5) for Tier-1
# extraction in the agentic pipeline.
#
